        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <form role="form" action="<?php echo base_url('orders/create') ?>" method="post"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="order_number" name="order_number"
                                        value="<?php echo 'ORD-'.strtoupper(uniqid()); ?>" readonly />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="time" name="time"
                                        value="<?php echo date('h:i a') ?>" autocomplete="off" />
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <tr id="row_1">
                                        <td>
                                            <select class="form-control select_group product" data-row-id="row_1"
                                                id="product_1" name="product[]" style="width:100%;" onchange="getProductData(1)">
                                                <option value=""></option>
                                        ...
                                        <td><input type="text" name="qty[]" id="qty_1" class="form-control" onkeyup="getTotal(1)"></td>
                                        <td>
                            ...
                            <div class="col-md-6 col-xs-12 pull pull-right">
                                ...
                                <div class="form-group">
                                    <label for="service_charge" class="col-sm-5 control-label">Service Charge
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo base_url('orders/manage') ?>" class="btn btn-warning">Back</a>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
        ...
        $.ajax({
            ...
            success: function(response) {
                var html = '<tr id="row_' + row_id + '">' +
                    ...
                    '" id="product_' + row_id + '" name="product[]" style="width:100%;" onchange="getProductData(' + row_id + ')">' +
                    '<option value=""></option>';
    ...
    if (product_id == "") {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#amount_" + row_id).prop('disabled', false);
...
function subAmount() {
    var service_charge = <?php echo $is_service_enabled ? $company_data['service_charge_value'] : 0; ?>;
    var vat_charge = <?php echo $is_vat_enabled ? $company_data['vat_charge_value'] : 0; ?>;
