    ...
    */
    public function fetchOrdersData()
    {
        ...
        foreach ($data as $key => $value) {
            ...
            $date = date('d-m-Y', $value['date_time']);  // This represents the date
            $time = date('h:i a', $value['date_time']);  // This represents the time

            // Concatenate date and time separately for clear labeling
            $date_time = 'Date: ' . $date . '<br>Time: ' . $time;
            ...
            $result['data'][$key] = array(
                ...
                $date_time,  // Ensure this shows "Date: [date] Time: [time]"
                $count_total_item,
                $value['net_amount'],
                $paid_status,
                $buttons
    ...
    */
    public function printDiv($id)
    {
        ...
        if ($id) {
            ...
            $order_date = date('d/m/Y', $order_data['date_time']); // This represents the date
            $order_time = date('h:i a', $order_data['date_time']); // This represents the time
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <h2 class="page-header">
                      ...
                      <small class="pull-right">Date: '.$order_date.'<br>Time: '.$order_time.'</small>
                    </h2>
                  </div>
                  <!-- /.col -->
                </div>
